// Example fleet & starting rates — update with your real vehicles and pricing.
export const fleet = [
  { id: 'dzire', name: 'Swift Dzire / Etios', type: 'Sedan', seats: '4+1', ac: true, fuel: 'Petrol/Diesel', rate: 12 },
  { id: 'ertiga', name: 'Maruti Ertiga', type: 'MUV', seats: '6+1', ac: true, fuel: 'Petrol/CNG', rate: 14 },
